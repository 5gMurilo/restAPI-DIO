...
public class ExceptionsHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<ExceptionResponse> handleSecurity(NotFoundException n){
        return ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY).body(new ExceptionResponse(n.getMessage()));
    }
}
